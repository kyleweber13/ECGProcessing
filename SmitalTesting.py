...
def combine_files(folder="/Users/kyleweber/Desktop/ECG_Validation_Descriptive/", remove_unknown=True):
    """Combines all descriptive stats files into single df. Returns said df.

    :argument
    -remove_unknown: boolean; if True, removes all "UNKNOWN" quality periods
    -folder:pathway to folder that contains all descriptive stats files generated in calc_descriptive()
    """
...
df_all_fft = import_fft_data(folder="/Users/kyleweber/Desktop/ECG_FFT/")
